...
export const formObj1={
  ...
  rules: { //必须有 命名不可变
    ...
    dateRange:[
      {type:'array',required:true,message:'请选择日期范围',trigger:'blur'}
    ],
    topicDate:[
      {type:'string',required:true,message:'请选择活动日期',trigger:'change'}
    ],
    topicTime:[
  ...
  formConfig:{ //必须有 命名不可变
    ...
    formItems:[
...

      {
        ...
        beforeFilter:function(){},//筛选之前的钩子，参数为输入的值，若返回 false 或者返回 Promise 且被 reject，则停止筛选
      ...
      },
      {
        ...
        inputSize:'mini',//输入框的尺寸	large / medium / small / mini
      ...
      },
      {
        ...
        disabled:false,//是否禁用
        rows:2,//输入框行数，只对 type="textarea" 有效
        autosize:{minRows:2},//自适应内容高度，只对 type="textarea" 有效，可传入对象，如，{ minRows: 2, maxRows: 6 }
        className:'',
        clearable:true,
      },
      {
